...
from llama_index.core.llms import MessageRole, ChatMessage, ChatResponse,CompletionResponse
...
llama_index.core.base.query_pipeline.query.validate_and_convert_stringable=validate_and_convert_stringable
...
def get_pipeline(
    ...
    # pipeline.add_link("agent_input", "react_prompt")

    # pipeline.add_link("react_prompt", "llm")
    # pipeline.add_link("llm", "react_output_parser")
