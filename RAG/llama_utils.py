"""
The two functions in this file `messages_to_prompt_v3_instruct()` and
`completion_to_prompt_v3_instruct` are for converting prompts to Llama 3 Instruct
format. I have contributed these two functions to llama_index.llms.llama_cpp.llama_utils.

FIXME: Remove this file whenever a stable release of LlamaIndex includes these two functions.
"""
