...
https://github.com/Edge-Intelligence-Lab/ChatDKU/assets/12345678/chatdku-promo-video.mp4
...
- **🤖 Agentic RAG Architecture**: Intelligent Agent based on DSPy, supporting multi-round retrieval and reasoning
- **🔍 Hybrid Retrieval System**: Combines vector retrieval (ChromaDB) and keyword retrieval (Redis BM25)
- **🧠 Intelligent Judging Mechanism**: Automatically evaluates retrieval sufficiency, iterative retrieval on demand
- **💬 Conversation Memory Management**: Supports long conversation context compression and memory retention
- **📊 Observability**: Integrated Phoenix (Arize) for full-chain tracing
- **🚀 Flexible Deployment**: Supports Agent-Only (CLI) and Full (Web application) modes
