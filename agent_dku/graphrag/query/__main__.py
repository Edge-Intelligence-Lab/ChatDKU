...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        default="/home/Glitterccc/projects/DKU_LLM/graphrag/output/20240715-182239/artifacts",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="what do you know about dku?",
    )

    args = parser.parse_args()
    config_path = "/home/Glitterccc/projects/DKU_LLM/graphrag/settings.yaml"
