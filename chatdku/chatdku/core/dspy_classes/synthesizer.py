...
def make_synthesizer_signature():
    ...
    instruction = (
        ...
        "Always select the following sources (1-11) and form a reference based on the sources you use:"
        "1. 2024-2025 Undergraduate Bulletin"
        ...
        "4. Understanding Major Declaration (No URL)"
        "5. Registration-Adding Seats to Full Courses Policy Updated, December 2024(No URL)"
        "6. Registration Planning Guide + Cheat Sheet(No URL)"
        "7. Overload Policy 23-24(No URL)"
        "8. Guide for Taking a Leave of Absence - Updated Fall 2023(No URL)"
        "9. CRNC FAQ for Advisors(No URL)"
        "10. Advising FAQ (12-19-24 Update)(No URL)"
        ...
        "Always provide answers without any references to the user."
