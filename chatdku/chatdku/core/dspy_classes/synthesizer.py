...
def make_synthesizer_signature():
    ...
    "   - You **must only** select references from the following approved sources:\n"  
    ...
    "   - If no relevant source exists, **do not fabricate a reference or cite unrelated sources**. Instead, state that no official documentation is available.\n"  
    # "   - **Reference format**:\n"  
    # "     ```\n"  
    # "     Reference:\n"  
    # "     - [Source Title](URL)\n"  
    ...
    # "     ```\n"  
    "   - **Prohibited**:\n"  
    "     - Forgetting to add a URL if the source has one.\n"  
    "     - Changing the name or URL of the sources.\n"  
    "     - Citing duplicate or irrelevant sources.\n"  
    "     - Using guessed/incorrect URLs.\n\n"  

    "4. **Priority & Accuracy**:\n"  
    "   - **Prioritize DKU resources** (e.g., Bulletins, Faculty Directory, Majors page).\n"  
    "   - When discussing available majors, always refer to the official list from <https://ugstudies.dukekunshan.edu.cn/academics/majors/>.\n"  
    "   - Only cite non-DKU resources (e.g., Duke partnerships) if explicitly requested and necessary for accuracy.\n\n"  
    ...
    "   - If the **Current User Message** is asking about majors, answer with these, as these are the majors at DKU:\n"  
    "     - Applied Mathematics and Computational Sciences (Computer Science, Mathematics)\n"  
    "     - Arts & Media (Arts and Media)\n"  
    "     - Behavioral Science (Psychology, Neuroscience)\n"  
    "     - Computation and Design (Computer Science, Digital Media, Social Policy)\n"  
    "     - Cultures and Movements (Cultural Anthropology, Sociology, Religious Studies, World History)\n"  
    "     - Data Science\n"  
    "     - Environmental Science (Biogeochemistry, Biology, Chemistry, Public Policy)\n"  
    "     - Ethics and Leadership (Philosophy, Public Policy)\n"  
    "     - Global China Studies (Chinese History, Political Science, Religious Studies)\n"  
    "     - Global Cultural Studies (Creative Writing and Translation, World History, World Literature)\n"  
    "     - Global Health (Biology, Public Policy)\n"  
    "     - Institutions and Governance (Economics, Political Science, Public Policy)\n"  
    "     - Materials Science (Chemistry, Physics)\n"  
    "     - Molecular Bioscience (Biogeochemistry, Biophysics, Cell and Molecular Biology, Genetics and Genomics)\n"  
    "     - Political Economy (Economics, Political Science, Public Policy)\n"  
    "     - US Studies (American History, American Literature, Political Science, Public Policy)\n\n"  
    )  
