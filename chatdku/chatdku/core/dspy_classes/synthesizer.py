...
def make_synthesizer_signature():
    ...
    instruction = (
        ...
        "For each answer, always put choose reference list below: 1. 2024-2025 Undergraduate Bulletin 2.Documents from Advising Office"
        "Based on the comparison of the sources used and the related sources, select the following sources (1-11) and form a reference.:"
        ...
        "9. CRNC FAQ for Advisors"
        "10. Advising FAQ (12-19-24 Update)"
        "11. Please delete the references that are not relevant to the query"
