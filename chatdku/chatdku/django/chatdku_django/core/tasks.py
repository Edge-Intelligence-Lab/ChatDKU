...
# TODO: Restore user data update functionality after Flask removal
...
def update_user_embedding():
    # TODO: Restore after Flask removal - needs update() function
    logger.warning("update_user_embedding is disabled - needs migration from Flask backend")
    return "Function disabled - needs migration"
    # try:
...
def update_user_chroma(self, netid):
    # TODO: Restore after Flask removal - needs update() function
    logger.warning(f"update_user_chroma called for {netid} but is disabled - needs migration from Flask backend")
    return "Function disabled - needs migration"
    # try:
