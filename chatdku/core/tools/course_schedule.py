...
def CourseScheduleLookupOuter(classdata_csv_path: str):
    """
    DSPy tool factory for looking up next-semester course schedule data.

    Args:
        classdata_csv_path: Path to the cleaned class-data CSV
                            (produced by scripts/clean_classdata.py).
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to the cleaned class-data CSV",
    )
    parser.add_argument(
        "courses",
        nargs="+",
    ...
    lookup = CourseScheduleLookupOuter(args.csv)
    __import__("pprint").pprint((lookup(args.courses)))
